...
function MenuItem({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center gap-3 px-3 py-1.5 text-xs text-left hover:bg-accent-blue hover:text-white transition-colors group"
    >
